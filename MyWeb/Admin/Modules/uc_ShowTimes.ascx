<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_ShowTimes.ascx.cs" Inherits="MyWeb.Admin.Modules.uc_ShowTimes" %>
<script type="text/javascript">
    $(function () {
        $("[id$=txtShowTime]").datepicker({ minDate: "0", autoSize: true });
    });
...
<asp:Panel ID="pnView" runat="server">
    <div id="search_block">
        Cinema:
            <asp:DropDownList ID="ddlFilterCinema" runat="server">
            </asp:DropDownList>
        Film:
            <%--<asp:TextBox ID="txtFilterName" runat="server" CssClass="text" Width="145px"></asp:TextBox>--%>
            <asp:DropDownList ID="ddlFilterFilm" runat="server">
            </asp:DropDownList>
        Status:
    ...
    <div class="Control">
        <ul>
            ...
            <li>
                <asp:LinkButton CssClass="uupdate" ID="lbtUpdatepriceT" runat="server" OnClick="lbtUpdatepriceT_Click">Update Price</asp:LinkButton></li>
            <li><a class="vback" href="javascript:void(0);" onclick="window.history.go(-1);">Back</a> </li>
        </ul>
    </div>
    <asp:DataGrid ID="grdShowTimes" runat="server" Width="100%" CssClass="TableView" AutoGenerateColumns="False" AllowPaging="True" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center" BorderStyle="Solid" OnItemCommand="grdShowTimes_ItemCommand" OnItemDataBound="grdShowTimes_ItemDataBound" OnPageIndexChanged="grdShowTimes_PageIndexChanged">
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="ShoId" HeaderText="Id" Visible="False" />
            ...
            <asp:TemplateColumn ItemStyle-CssClass="Text">
                ...
                <ItemTemplate>
                    <asp:Label ID="grdLblName" runat="server" Text='<%#(Eval("FilId").ToString())%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:TemplateColumn>
            <asp:TemplateColumn HeaderText="ShowTime">
                <ItemTemplate>
                    <asp:Label ID="grdLblShowTime" runat="server" Text='<%#MyWeb.Common.DateTimeClass.ConvertDate(Eval("ShowTime").ToString())%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:TemplateColumn>
            <asp:TemplateColumn HeaderText="Time">
                <ItemTemplate>
                    <asp:Label ID="grdLblTime" runat="server" Text='<%# (Eval("Time").ToString())%>'></asp:Label>
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:TemplateColumn>
            <asp:TemplateColumn ItemStyle-CssClass="Moneysmall">
                <HeaderTemplate>
                    Price
                        <asp:LinkButton CssClass="sortasc" ID="lbtascPrice" CommandName="ascPrice" runat="server"
                            ToolTip="Sort ascending">s</asp:LinkButton><asp:LinkButton CssClass="sortdesc"
                                ID="lbtdescPrice" CommandName="descPrice" runat="server" ToolTip="Sort descending">s</asp:LinkButton>
                </HeaderTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateColumn ItemStyle-CssClass="Function">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="cmdEdit" runat="server" AlternateText="Edit" CommandName="Edit" ToolTip="Edit" ImageUrl="/App_Themes/Admin/images/edit.png" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ShoId")%>' />
                    <asp:ImageButton ID="cmdDelete" runat="server" AlternateText="Delete" CommandName="Delete" ToolTip="Delete" ImageUrl="/App_Themes/Admin/images/delete.png" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ShoId")%>' OnClientClick="javascript:return confirm('Do you want to delete?');" /><asp:ImageButton
                        ...
                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"ShoId")%>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:TemplateColumn>
        </Columns>
    ...
    <div class="Control">
        <ul>
            ...
            <li>
                <asp:LinkButton CssClass="uupdate" ID="lbtUpdatepriceB" runat="server" OnClick="lbtUpdatepriceB_Click">Update Price</asp:LinkButton></li>
            <li><a class="vback" href="javascript:void(0);" onclick="window.history.go(-1);">Back</a> </li>
        </ul>
    </div>
</asp:Panel>
...
<asp:Panel ID="pnUpdate" runat="server" Visible="False">
    <table class="TableUpdate" style="border-collapse: collapse" cellpadding="0" width="100%" border="1">
        ...
        <tr>
            <td class="name_fild_row">&nbsp;<asp:Label ID="lblFilId" runat="server">Film</asp:Label></td>
            <td>
                <asp:DropDownList ID="ddlFilId_Update" runat="server" CssClass="text"></asp:DropDownList>
                <asp:HiddenField ID="txtId" runat="server" />
            </td>
        </tr>
        <tr>
            <td class="name_fild_row">&nbsp;<asp:Label ID="lblCinId" runat="server">Cinema</asp:Label></td>
            <td>
                <asp:DropDownList ID="ddlCinId_Update" runat="server" CssClass="text"></asp:DropDownList></td>
        </tr>
        <tr>
            <td class="name_fild_row">&nbsp;<asp:Label ID="lblShowTime" runat="server">ShowTime</asp:Label></td>
            <td>
                <asp:TextBox ID="txtShowTime" runat="server" CssClass="text"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="name_fild_row">&nbsp;<asp:Label ID="lblTime" runat="server">Time</asp:Label></td>
            <td>
                <asp:TextBox ID="txtTime" runat="server" CssClass="text"></asp:TextBox></td>
        </tr>
        <tr>
            <td class="name_fild_row">&nbsp;<asp:Label ID="lblPrice" runat="server">Price</asp:Label></td>
            <td>
                <asp:TextBox ID="txtPrice" runat="server" CssClass="text" onkeypress="return ValidateKeypress(/\d/,event);"></asp:TextBox></td>
        </tr>
        <tr>
