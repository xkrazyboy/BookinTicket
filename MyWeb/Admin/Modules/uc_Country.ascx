<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Country.ascx.cs" Inherits="MyWeb.Admin.Modules.uc_Country" %>
<div class="PageName">
    Country
</div>
<asp:Panel ID="pnView" runat="server">
    ...
    <asp:DataGrid ID="grdCountry" runat="server" Width="100%" CssClass="TableView" AutoGenerateColumns="False" AllowPaging="True" PagerStyle-Mode="NumericPages" PagerStyle-HorizontalAlign="Center" BorderStyle="Solid" OnItemCommand="grdCountry_ItemCommand" OnItemDataBound="grdCountry_ItemDataBound" OnPageIndexChanged="grdCountry_PageIndexChanged">
        ...
        <Columns>
            ...
            <asp:BoundColumn DataField="CouId" HeaderText="Id" Visible="False" />
            <asp:BoundColumn DataField="Status" HeaderText="Active" Visible="False" />
            <asp:TemplateColumn ItemStyle-CssClass="Text">
                <HeaderTemplate>
                    Country
                    <asp:LinkButton CssClass="sortasc" ID="lbtascCountry" CommandName="ascCountry" runat="server" ToolTip="Sort ascending">s</asp:LinkButton>
                    <asp:LinkButton CssClass="sortdesc" ID="lbtdescCountry" CommandName="descCountry" runat="server" ToolTip="Sort descending">s</asp:LinkButton>
                </HeaderTemplate>
                <ItemTemplate>
                    <asp:Label ID="grdLblName" runat="server" Text='<%#(Eval("NameCo").ToString())%>'></asp:Label>
                </ItemTemplate>
            ...
            <asp:TemplateColumn ItemStyle-CssClass="Function">
                ...
                <ItemTemplate>
                    <asp:ImageButton ID="cmdEdit" runat="server" AlternateText="Edit" CommandName="Edit" ToolTip="Edit" ImageUrl="/App_Themes/Admin/images/edit.png" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"CouId")%>' />
                    <asp:ImageButton ID="cmdDelete" runat="server" AlternateText="Delete" CommandName="Delete" ToolTip="Delete" ImageUrl="/App_Themes/Admin/images/delete.png" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"CouId")%>' OnClientClick="javascript:return confirm('Do you want to delete?');" /><asp:ImageButton
                        ...
                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"CouId")%>' />
                </ItemTemplate>
                <ItemStyle HorizontalAlign="Center" Width="100px" />
            </asp:TemplateColumn>
        </Columns>
