<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="uc_Movie.ascx.cs" Inherits="MyWeb.Modules.uc_Movie" %>
<div class="group" id="list-movie">
    <div class="group-title"><span class="title">MOVIE</span></div>
